...
go mod tidy
Write-Success "Dependencies installed (including Swagger)"
...
Write-Host "  3. Install swag CLI: go install github.com/swaggo/swag/cmd/swag@latest" -ForegroundColor White
Write-Host "  4. Generate Swagger docs: swag init -g cmd/server/main.go --output docs" -ForegroundColor White
Write-Host "  5. go run cmd/server/main.go" -ForegroundColor White
Write-Host "  6. Open http://localhost:8080/swagger/index.html" -ForegroundColor White
Write-Host "`n"
